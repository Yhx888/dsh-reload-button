...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function ensureTriggerButton() {
      ...
      if (settings === null || !settings.isConnected || settings.parentElement === null) return false;
      ...
      settings.parentElement.insertBefore(btn, settings.nextSibling);
      return true;
    }
